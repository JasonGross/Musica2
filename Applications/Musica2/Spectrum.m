...
Usage[Append,Musica2,Tone,{{_,_?NumberQ}, ___?OptionQ},_Tone,"todo"]
Tone[{f_,c_?NumberQ}, opts___?OptionQ] := Tone[{f,{Abs[c],Arg[c]}},opts]

Usage[Append,Musica2,Tone,{_, ___?OptionQ},_Tone,"todo"]
...
Usage[Append,Musica2,Complex,{_Tone},_Complex,"todo"]
Tone /: Complex[x_Tone] := complex[Amplitude[x],Phase[x]]

(* Tone common functions ********************************************************************)

Usage[Append,Musica2,Tidy,{Tone},_Function,"todo"]
Tidy[Tone] = Module[{r = #},
  If[Frequency[r] < 0,
...
Usage[Append,Musica2,Plus,{_Tone,_Tone},_ToneSpectrum,"todo"]
Tone /: Plus[a_Tone,b_Tone] := ToneSpectrum[{a,b}]

Usage[Append,Musica2,Power,{_Tone,2},_ToneSpectrum,"todo"]
Tone /: Power[a_Tone,2] := a*a

Usage[Append,Musica2,Times,{_Tone,_Tone},_ToneSpectrum,"todo"]
...
Usage[Append,Musica2,ToneSpectrum,{_Snippet, ___?OptionQ},_ToneSpectrum,"todo"]
...
Usage[Append,Musica2,ToneSpectrum,{{__?AtomQ}, ___?OptionQ},_ToneSpectrum,"todo"]
ToneSpectrum[x:{__?AtomQ}, opts___?OptionQ] := ToneSpectrum[Tone /@ x,opts]

(* ToneSpectrum reverse constructors ********************************************************)

Usage[Append,Musica2,Snippet,{_ToneSpectrum, ___?OptionQ},_Snippet,"todo"]
...
Usage[Append,Musica2,Mix,{{__ToneSpectrum}, ___?OptionQ},_ToneSpectrum,"todo"]
Mix[x:{__ToneSpectrum}, opts___?OptionQ] := ToneSpectrum[Flatten[Tone /@ x]]

Usage[Append,Musica2,Tidy,{ToneSpectrum},_Function,"todo"]
...
Usage[Append,Musica2,Plus,{_ToneSpectrum, _ToneSpectrum},_ToneSpectrum,"todo"]
ToneSpectrum /: Plus[a_ToneSpectrum,b_ToneSpectrum] := ToneSpectrum[Join[Tone[a],Tone[b]]]

Usage[Append,Musica2,Plus,{_ToneSpectrum, _Tone},_ToneSpectrum,"todo"]
ToneSpectrum /: Plus[a_ToneSpectrum,b_Tone] := ToneSpectrum[Append[Tone[a],b]]

Usage[Append,Musica2,Plus,{_Tone, _ToneSpectrum},_ToneSpectrum,"todo"]
ToneSpectrum /: Plus[b_Tone,a_ToneSpectrum] := ToneSpectrum[Append[Tone[a],b]]

Usage[Append,Musica2,Power,{_ToneSpectrum, 2},_ToneSpectrum,"todo"]
ToneSpectrum /: Power[a_ToneSpectrum,2] := a*a

Usage[Append,Musica2,Times,{_ToneSpectrum, _ToneSpectrum},_ToneSpectrum,"todo"]
ToneSpectrum /: Times[a_ToneSpectrum,b_ToneSpectrum] := ToneSpectrum[Flatten[Tone /@ (a*Tone[b])]]

Usage[Append,Musica2,Times,{_ToneSpectrum, _Tone},_ToneSpectrum,"todo"]
ToneSpectrum /: Times[a_ToneSpectrum,b_Tone] := ToneSpectrum[Flatten[Tone /@ (Tone[a] * b)]]

Usage[Append,Musica2,Times,{_Tone, _ToneSpectrum},_ToneSpectrum,"todo"]
